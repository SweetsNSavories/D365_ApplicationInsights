...
> *"@workspace Use [`DASHBOARD-slow-sql.md`](./DASHBOARD-slow-sql.md). Regenerate tiles 01-05 in my F&O App Insights — cluster URI `<...>`, database `<...>`. Skip tile 00; that's a reference, not a dashboard tile."*
