...
This repository is a **library of standalone Kusto (KQL) queries** for troubleshooting Microsoft Dynamics 365 and Power Platform workloads via Azure Application Insights. There is no buildable source code — only `.kql` files and Markdown.
